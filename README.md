...
|-- collections
|   |-- ansible_collections/k8s/rke2lifecycle
|   |   `-- roles/rke2lifecycle
|   `-- requirements.yml
...
ansible-playbook --syntax-check rke2lifecycle.yaml
ansible-lint rke2lifecycle.yaml collections/ansible_collections/k8s/rke2lifecycle
ansible-galaxy collection build collections/ansible_collections/k8s/rke2lifecycle
```
...
ansible-playbook rke2lifecycle.yaml -e rke2_target_version=v1.35.7+rke2r1
```
